 ...
 */
package com.github.naoghuman.testdata.abclist.view.testdatalinkmapping;
 ...
 * @author Naoghuman
 */
public class TestdataLinkMappingPresenter implements Initializable, IPreferencesConfiguration {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        LoggerFacade.getDefault().info(this.getClass(), "Initialize TestdataLinkMappingPresenter"); // NOI18N
        
        assert (cbQuantityEntities != null)             : "fx:id=\"cbQuantityEntities\" was not injected: check your FXML file 'testdatalinkmapping.fxml'."; // NOI18N
        assert (lProgressBarInformation != null)        : "fx:id=\"lProgressBarInformation\" was not injected: check your FXML file 'testdatalinkmapping.fxml'."; // NOI18N
        assert (lProgressBarPercentInformation != null) : "fx:id=\"lProgressBarPercentInformation\" was not injected: check your FXML file 'testdatalinkmapping.fxml'."; // NOI18N
        assert (pbEntity != null)                       : "fx:id=\"pbEntity\" was not injected: check your FXML file 'testdatalinkmapping.fxml'."; // NOI18N
    ...
    private void initializeComboBoxes() {
        ...
        final Integer quantityEntities = PreferencesFacade.getDefault().getInt(
                PREF__TESTDATA__QUANTITY_ENTITIES__LINK_MAPPING,
                PREF__TESTDATA__QUANTITY_ENTITIES__LINK_MAPPING_DEFAULT_VALUE);
    ...
    public void onActionQuantityEntities() {
        ...
        PreferencesFacade.getDefault().putInt(PREF__TESTDATA__QUANTITY_ENTITIES__LINK_MAPPING, quantityEntities);
    }
