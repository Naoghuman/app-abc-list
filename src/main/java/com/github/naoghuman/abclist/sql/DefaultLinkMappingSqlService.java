 ...
 * @author Naoghuman
 */
public final class DefaultLinkMappingSqlService implements IDefaultConfiguration, ILinkMappingConfiguration, LinkMappingSqlService {
    ...
    public void createLinkMapping(final LinkMapping linkMapping) {
        if (Objects.equals(linkMapping.getId(), DEFAULT_ID)) {
            ...
            this.updateLinkMapping(linkMapping);
        }
    }
