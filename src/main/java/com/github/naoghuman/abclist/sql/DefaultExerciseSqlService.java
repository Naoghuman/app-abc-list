 ...
 * @author Naoghuman
 */
final class DefaultExerciseSqlService implements 
        IDefaultConfiguration, IExerciseConfiguration, ExerciseSqlService
{
    @Override
    ...
    public Optional<Exercise> findExercise(long exerciseId) {
        return Optional.ofNullable(DatabaseFacade.getDefault().getCrudService().findById(Exercise.class, exerciseId));
    }
